...
The goal is structural maturity.

---

## 2. Phase I — Foundation
...
This phase belongs primarily to:
...
## 3. Phase II — Canonical Branch Stabilization
...
## 4. Phase III — Ecosystem Consolidation

### Objective

Order the existing repositories into a readable ecosystem.
...
Move each canonical branch from conceptual naming to stable methodological form.
...
Each branch becomes methodologically intelligible, not only conceptually named.
...
#### A. Diagnostics reference implementation
...
Move from internal coherence to external pressure.
...
The framework itself is not the product.

Products emerge from branches.
...
- structural analysis modules for scientific workflows

### Rule

Products must remain downstream of the framework, not fused with it.
...
In that sense, maturity means:

- stable foundations
- stable branch taxonomy
